...
const EditModal = ({ department, isOpen, onClose, onConfirm }) => {
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                <div className="bg-white p-6 rounded-lg shadow-lg w-96">
                    ...
                    <div className="text-gray-600 mt-4 space-y-2">
                        ...
                        <p><strong>Access Level:</strong> {department.accessLevel}</p>
                        <p><strong>Permissions:</strong> {department.permissions.join(', ')}</p>
                    </div>
